...
const main = async (res) => {
    ...
    let info = await transporter.sendMail({
      ...
      text: "a definir", // plain text body
      html: "<b>a definir</b>", // html body
    });
    //Set Log de Envio
    //envs.write(`E-mail: ${snd.mail}, enviado. Status Message: ${JSON.stringify(info)}, arquivos Anexados: ${snd.attachments.length().toString().padStart(2, '0')}`)
